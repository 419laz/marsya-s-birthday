(() => {
  ...
  function playPaperSfx() {
    try {
      ...
      filter.frequency.exponentialRampToValueAtTime(3200, now + duration * 0.6);
      ...
      gain.gain.exponentialRampToValueAtTime(0.3, now + duration * 0.5);
      ...
      console.error("playPaperSfx failed:", err);
    }
  }
